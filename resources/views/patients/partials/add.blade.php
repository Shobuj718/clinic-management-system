...
<div class="modal-dialog" style="width:75%">
  <div class="modal-content">
      ...
      <div class="row">
		...
		<div class=" col-md-4 form-group">
			<label>Country:</label>
		 	{!! Form::text('country', 'Bangladesh', array('class' => 'form-control')) !!}
		</div>
		<div class=" col-md-4 form-group">
			<label>State:</label>
		 	{!! Form::text('state', 'Rajshahi', array('class' => 'form-control')) !!}
		</div>
		<div class=" col-md-4 form-group">
			<label>District:</label>
		 	{!! Form::text('district', 'Bogura', array('class' => 'form-control')) !!}
		</div>
		<div class=" col-md-4 form-group">
			<label>Location:</label>
			{!! Form::textarea('location', 'Bogura', array('class' => 'form-control','required'=>'required','size' => '5x3')) !!}
		</div>
